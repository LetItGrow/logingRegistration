...
public class UserController {
    ...
    //新增用户信息
    @RequestMapping(value = "/list/user/insert.action",
    ...
    // 判断用户名是否存在
    @RequestMapping(value = "/list/user/findByName.action",
            produces = "text/json;charset=UTF-8",
            method= RequestMethod.POST)
    @ResponseBody
    ...
    // 判断用户名和密码是否存在
    @RequestMapping(value = "/list/user/getByNameAndPass.action",
            produces = "text/json;charset=UTF-8",
            method= RequestMethod.POST)
    @ResponseBody
